...
sentinel_cfg = InnovaConfig.tokenize(sentinel_config_file)
sentinel_version = "1.1.0"
min_innovad_proto_version_with_sentinel_ping = 70207


def get_innova_conf():
    home = os.environ.get('HOME')

    innova_conf = os.path.join(home, ".innovacore/innova.conf")
    if sys.platform == 'darwin':
        innova_conf = os.path.join(home, "Library/Application Support/InnovaCore/innova.conf")

    innova_conf = sentinel_cfg.get('innova_conf', innova_conf)
