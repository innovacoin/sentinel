...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to innovad "gobject list" output
    ...
    def innovad_serialise(self):
        import innovalib
        return innovalib.SHIM_serialise_for_innovad(self.serialise())
